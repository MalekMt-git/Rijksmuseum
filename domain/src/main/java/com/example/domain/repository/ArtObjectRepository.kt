...
interface ArtObjectRepository {
    ...
    suspend fun saveArtObjectDetails(detailsAPIResponse: DetailsArtObject)
    suspend fun deleteSavedArtObjectDetails(detailsAPIResponse: DetailsArtObject)
    fun getSavedArtObjectsDetails() : Flow<List<DetailsArtObject>>
}